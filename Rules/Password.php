...
use Voyager\Contracts\Validation\Rule;
use Voyager\Contracts\Validation\UncompromisedVerifier;
...
class Password implements DataAwareRule, ImplicitRule, IteratorAggregate, Rule, ValidatorAwareRule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        if ($this->uncompromised && ! Vessel::getInstance()->make(UncompromisedVerifier::class)->verify([
            'value' => $value,
