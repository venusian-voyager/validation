...
namespace Voyager\Validation\Concerns;
...
use Voyager\Validation\ValidationData;
...
trait ValidatesAttributes
{
    ...
    public function validateEmail($attribute, $value, $parameters)
    {
        ...
        $emailValidator = Vessel::getInstance()->make(EmailValidator::class);
     ...
     * @return mixed
     *
     * @throws \Voyager\NutsAndBolts\Exceptions\MathException
     */
